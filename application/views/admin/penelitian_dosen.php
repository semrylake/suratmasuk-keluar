...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Data Penelitian Dosen</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php if ($isEdit == false) { ?>
                            <form method="POST" action="<?= base_url('index.php/admin/dosen/insertPenelitianDosen') ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tempat" placeholder="Enter Tempat" name="tempat">
                                </div>
                                <div class="form-group">
                        ...
                        <?php } else { ?>
                            <form method="POST" action="<?= base_url('index.php/admin/dosen/updatePenelitianDosen/' . $edit->id) ?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="id_dosen">Dosen</label>
                                    <select class="form-control" id="id_dosen" name="id_dosen">
                                        <?php foreach ($dosen as $d) : ?>
                                            <?php if ($d->id == $edit->id_dosen) { ?>
                                ...
                                <div class="form-group">
                                    <label for="tempat">Tempat</label>
                                    <input type="text" class="form-control" id="tempat" placeholder="Enter Tempat" name="tempat" value="<?= $edit->tempat ?>">
                                </div>
                                <div class="form-group">
                                    <label for="tahun_penelitian">Tahun</label>
            ...
            <div class="col-9">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data Penelitian Dosen</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <div class="col-sm-12">
                                    <div class="table-responsive">
                                        <table id="dataTable" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Dosen</th>
                                                    ...
                                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Tempat Penelitian</th>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($data_d as $d) :
                                                    ...
                                                    <tr class="<?php ($i % 2 == 0) ? 'even' : 'odd' ?>">
                                                        ...
                                                        <td>
                                                            <a href="<?= base_url('index.php/admin/dosen/editPenelitian/' . $d->id) ?>" class="btn btn-warning mb-2 btn-sm"><i class="fa text-white fa-edit"></i></a>
                                                            <a href="<?= base_url('index.php/admin/dosen/delete_penelitian/' . $d->id) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                                        </td>
